...
if ($user) 
{
    if ($datauser['url_avatar'] == ''){
        $datauser['url_avatar'] = $_DOMAIN.'img/profile.png';
    }
    else{
        $datauser['url_avatar'] = str_replace('admin/', '', $_DOMAIN).$datauser['url_avatar'];
    }
    echo
    '
        <h3>Hồ sơ cá nhân</h3>
            ...
            <div class="panel-body">
                <form action="' . $_DOMAIN . 'profile.php" method="POST" onsubmit="return false;" id="formUpAvt" enctype="multipart/form-data">
                    <div class="form-group box-current-img">
                        ...
                        <img src="' . $datauser['url_avatar'] . '" alt="Ảnh đại diện của ' . $datauser['display_name'] . '" width="80" height="80">
                    </div>
        ...
        <div class="panel-body">
            <form method="POST" onsubmit="return false;" id="formUpdateInfo">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dn_update" value="' . $datauser['display_name'] . '">
                </div>
                <div class="form-group">
                    <label>Email *</label>
                    <input type="text" class="form-control" id="email_update" value="' . $datauser['email'] . '">
                </div>
                <div class="form-group">
                    <label>URL Facebook</label>
                    <input type="text" class="form-control" id="fb_update" value="' . $datauser['facebook'] . '">
                </div>
                <div class="form-group">
                    <label>URL Google</label>
                    <input type="text" class="form-control" id="gg_update" value="' . $datauser['google'] . '">
                </div>
                <div class="form-group">
                    <label>URL Twitter</label>
                    <input type="text" class="form-control" id="tt_update" value="' . $datauser['twitter'] . '">
                </div>
                <div class="form-group">
                    <label>Số điện thoại</label>
                    <input type="text" class="form-control" id="phone_update" value="' . $datauser['phone'] . '">
                </div>
                <div class="form-group">
                    <label>Giới thiệu</label>
                    <textarea id="desc_update" class="form-control">' . $datauser['description'] . '</textarea>
                </div>
                <div class="form-group">
